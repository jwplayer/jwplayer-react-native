...
| **`onFullScreenExitRequested`**  | Player is about to exit fullscreen. On **iOS** (SDK 4.28.0+) the event carries `reason` (see `FullScreenExitReason` in index.d.ts); on earlier iOS SDKs and on **Android** no `reason` is sent.                             | On **iOS** `{ reason?: string }`, on **Android** `{ message: string }`                                                                                                                                                                                                                                                           |
| **`onFullScreenExit`**           | Player exited fullscreen. On **iOS** (SDK 4.28.0+) the event carries `reason` (see `FullScreenExitReason` in index.d.ts); on earlier iOS SDKs and on **Android** no `reason` is sent.                                       | On **iOS** `{ reason?: string }`, on **Android** `{ message: string }`                                                                                                                                                                                                                                                           |
