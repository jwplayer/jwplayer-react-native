...
| **`onFullScreenExit`**           | Player exited fullscreen. Carries `reason` on both platforms in different, non-interchangeable wire formats — camelCase on iOS (SDK 4.28.0+, `FullScreenExitReasonIOS`), hyphenated on Android (`FullScreenExitReasonAndroid`). | `{ message: string, reason?: string }`                                                                                                                                                                                                                                                                                           |
